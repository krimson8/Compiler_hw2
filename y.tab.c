...
union YYSTYPE
{
#line 32 "compiler_hw2.y" /* yacc.c:355  */
...
{
       0,    69,    69,    70,    74,    81,    89,   112,   113,   117,
     118,   119
};
#endif
...
static const char *const yytname[] =
{
  ...
  "VAR", "NEWLINE", "ADD", "SUB", "MUL", "DIV", "MOD", "INC", "DEC", "GT",
  "LT", "GE", "LE", "EQUAL", "NOTEQ", "AS", "INCAS", "DECAS", "MULAS",
  "DIVAS", "MODAS", "AND", "OR", "NOT", "LB", "RB", "LGB", "RGB",
  "I_CONST", "F_CONST", "STRING", "ID", "INT", "FLOAT", "VOID", "$accept",
  "program", "stat", "declaration", "initializer", "type", YY_NULLPTR
};
#endif
...
{
      11,     2,     7,     8,     9,    13,    14,     6,    16,     3,
       0,     0,     0,     0,    12
};

static const yytype_int8 yycheck[] =
{
       9,     0,    40,    41,    42,    36,    37,    39,     9,     8,
      -1,    -1,    -1,    -1,    23
};
...
#line 81 "compiler_hw2.y" /* yacc.c:1646  */
    {
        insert_symbol((yyvsp[-4].string), (yyvsp[-3].string));
        if(strcmp((yyvsp[-3].string), "int") == 0) 
            table[count].int_val = (yyvsp[-1].f_val);
        else if(strcmp((yyvsp[-3].string), "float32") == 0) 
            table[count].double_val = (yyvsp[-1].f_val);
        count++;
    }
...
#line 89 "compiler_hw2.y" /* yacc.c:1646  */
    {
        insert_symbol((yyvsp[-2].string), (yyvsp[-1].string));
        if(strcmp((yyvsp[-1].string), "int") == 0) 
            table[count].int_val = 0;
        else if(strcmp((yyvsp[-1].string), "float32") == 0) 
...
#line 122 "compiler_hw2.y" /* yacc.c:1906  */
